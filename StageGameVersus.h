...
//Class gérant le jeu 1vs 1: deux lumières allumees, en miroir, une dans chaque camp. quand on appuie dessus les deux lumières allumées changent, on gagne des points
...
private:
	...
	byte lightOn; // Correspond a la light actuellement allumée (entre 0 et 9): si les joueurs tapent sur une autre light, ils perdent des points, sinon ils en gagnent et la light change.
